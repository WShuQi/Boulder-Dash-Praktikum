...
public class MainRulesJson {
    ...
    private boolean isType(String text){
        boolean boo = false;
        if(text.toUpperCase().equals("DIAMOND") | text.toUpperCase().equals("ME") | text.toUpperCase().equals("GEM") | text.toUpperCase().equals("MUD") | text.toUpperCase().equals("STONE") | text.toUpperCase().equals("BRICKS") | text.toUpperCase().equals("PATH") | text.toUpperCase().equals("EXIT") | text.toUpperCase().equals("WALL") | text.toUpperCase().equals("EXPLOSION") | text.toUpperCase().equals("FIRE") | text.toUpperCase().equals("POT") | text.toUpperCase().equals("SIEVE") | text.toUpperCase().equals("SAND") | text.toUpperCase().equals("SLIME") | text.toUpperCase().equals("SWAPLING") | text.toUpperCase().equals("BLOCKLING") | text.toUpperCase().equals("XLING") | text.toUpperCase().equals("GHOSTLING") | text.toUpperCase().equals("NORTHTHING") | text.toUpperCase().equals("CATCHALL") | text.toUpperCase().equals("LOCH") | text.toUpperCase().equals("WESTTHING") | text.toUpperCase().equals("SOUTHTHING") | text.toUpperCase().equals("EASTTHING")){
            boo = true;
        }
        return boo;
    }
